...
default_vals['cmd-out'] = 'touch /tmp/test';
...
$(document).ready(function() {
	...
	$("#dialog-form").dialog({
		...
		buttons: {
			'Submit': function() {
				document.getElementById("UserCrontabEmailForm").submit();
			},
			Cancel: function() {
				$(this).dialog('close');
			}
	...
	$("button#set_script").button().click(function() {
		output_vals['cmd-out'] = '/opt/ucron/scripts/' + $("#scripts option:selected").val();
		crontab(output_vals);
	});
